...
public class InsereFreteFromDto implements Serializable {
	...
	public String toString() {
		return "InsereFreteFromDto [document=" + document + ", companyDocument=" + companyDocument + "]";
	}	
}